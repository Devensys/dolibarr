...
/**
 *      \file       dev/skeletons/htaccessprotectaccount_script.php
 *		\ingroup    mymodule
...
require_once(DOL_DOCUMENT_ROOT."/../dev/skeletons/htaccessprotectaccount.class.php");
$myobject=new Htaccessprotectaccount($db);
