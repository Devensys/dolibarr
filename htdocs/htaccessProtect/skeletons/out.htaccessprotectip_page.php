...
/**
 *   	\file       dev/Htaccessprotectips/Htaccessprotectip_page.php
...
dol_include_once('/module/class/htaccessprotectip.class.php');
...
$object=new Htaccessprotectip($db);
...
if ($action == 'list' || empty($id))
{
    ...
    $sql.= " FROM ".MAIN_DB_PREFIX."htaccessprotect_ip as t";
