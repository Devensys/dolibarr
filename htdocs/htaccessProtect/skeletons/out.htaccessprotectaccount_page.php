...
/**
 *   	\file       dev/Htaccessprotectaccounts/Htaccessprotectaccount_page.php
...
dol_include_once('/module/class/htaccessprotectaccount.class.php');
...
$object=new Htaccessprotectaccount($db);
...
if ($action == 'list' || empty($id))
{
    ...
    $sql.= " FROM ".MAIN_DB_PREFIX."htaccessprotect_account as t";
